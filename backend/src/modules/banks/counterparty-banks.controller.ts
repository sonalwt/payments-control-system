...
@ApiTags('Counterparty Banks')
@ApiBearerAuth()
@UseGuards(JwtAuthGuard, RolesGuard)
@Roles(RoleCode.SUPER_ADMIN, RoleCode.COUNTERPARTY)
@Controller('counterparty/banks')
export class CounterpartyBanksController {
  constructor(private readonly service: BanksService) {}

  @Post()
  create(@Body() dto: CreateBankDto, @CurrentUser() user: AuthenticatedUser) {
