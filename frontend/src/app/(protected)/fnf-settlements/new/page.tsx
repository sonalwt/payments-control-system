  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold">New Full & Final Settlement</h1>
          <p className="text-muted-foreground text-sm">Initiate a full and final settlement for an exiting employee</p>
        </div>
      </div>
      ...
      {isReady && (
        <PaymentRequestForm
          ...
          defaultValues={{ paymentTypeCode: 'FNF' }}
